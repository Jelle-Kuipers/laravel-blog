            ...
            <div id="postsHead" class="d-flex justify-content-between">
                ...
                @if ($user->permission->create_update_post == 1)
                    <a id="switch" class="btn btn-primary d-flex align-items-center"><i id="minusIcon"
                            class="fa-solid fa-minus d-none"></i> <i id="plusIcon" class="fa-solid fa-plus"></i><span
            ...
            <div id="seePosts">
                ...
                <div class="row" style="margin-top: 1.5rem;">
                        <div class="col-lg-4">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href={{ route('post@singlePost', ['id' => $post->id]) }}><img class="card-img-top" src="{{ $post->thumbnail_path }}"
                                        alt="Post Thumbnail" style="max-height: 350px;" /></a>
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-primary" href={{ route('post@singlePost', ['id' => $post->id]) }}>Read more <i
